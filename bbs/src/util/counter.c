...
main()
{
  ...
  {
    fprintf(fp, "\033[1;37m◎ %s \033[31m本站註冊人數\033[1;37m 狂賀超過 \033[31m%5d\033[37m 人\033[m\n", date, num);
  ...
  {
    fprintf(fp, "\033[1;37m◎ %s \033[32m同時線上人數\033[1;37m 首次達到 \033[32m%5d\033[37m 人\033[m\n", date, num);
  ...
  if (ptime->tm_hour == 23)	/* 每天計算一次本日上站人次 */
  {
    ...
    {
      fprintf(fp, "\033[1;37m◎ %s \033[33m單日上站人次\033[1;37m 正式突破 \033[33m%5d\033[37m 人\033[m\n", date, num);
  ...
  {
    fprintf(fp, "\033[1;37m◎ %s \033[34m本站看板個數\033[1;37m 宣佈高達 \033[34m%5d\033[37m 個\033[m\n", date, num);
