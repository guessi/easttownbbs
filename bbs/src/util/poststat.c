  ...
  int mytype;
{
  ...
  if (fp = fopen(curfile, "w"))
  {
    ...
    fprintf(fp, "\t\t\033[1;34m-----\033[37m=====\033[41m 本%s大熱門話題 \033[40m=====\033[34m-----\033[m\n\n", 
      mytitle[mytype]);
    ...
    for (i = cnt = 0; (cnt < max) && (i < j); i++)
    {
      ...
      buf[23] = '\0';
      fprintf(fp,
	"\033[1;31m%3d. \033[33m看板 : \033[32m%-16s\033[35m《%s》\033[36m%4d 篇\033[33m%+16s\033[m\n"
	"     \033[33m標題 : \033[37;44m%-60.60s\033[m\n", 
