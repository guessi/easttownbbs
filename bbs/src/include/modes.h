...
#define CTECHO		0x0800		/* Bone.070427 Count Echo */
...
#define XO_TALL		(b_lines - 3)	/* 3 => head/neck/foot */
...
#define XZ_CREDIT	(XO_ZONE + 14)	/* 計帳手札 */
#define XZ_TOEAT        (XO_ZONE + 15)  /* 要吃哪裡 */
#endif				/* _MODES_H_ */
