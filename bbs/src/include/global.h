...
#define FN_RUN_ADMIN    "run/admin.log" /* 站務行為紀錄 */

#define FN_RUN_NOINCOME	"run/noincome.log"	/* log noincome ban list */

#define FN_RUN_CBM	"run/ChangeBM.log"

#define FN_RUN_CRN      "run/ChangeRealName.log"  /* 使用者更名紀錄 */

#define FN_RUN_REG	"run/reg.log"	/* 通過初步認證紀錄 */

#define	FN_RUN_USIES	"run/usies"	/* BBS使用記錄 */
...
#define FN_ETC_MJUSTIFIED "etc/mjustified"	/* 初步通過通知 (初步認證時，寄到站內信箱) */
...
#define FN_ETC_ANNOUNCE "etc/announce-motd"     /* 進站醒目公告 */
...
#define BN_SPAM_DEL	"SPAM_DEL"	/* Spam Mail Collect Board */
#define BN_BMTA		"BMTA_LOG"	/* bmta log */
#define BN_CPRECORD	"CPRECORD"	/* record user cp */
#define BN_ALLPOST	"All_Post"	/* All User Post Record */
#define BN_DEPARTALL	"DepartAll"	/* Department All */
#define BN_NEWBOARD	"NewBoard"	/* NewBoard */
...
#define STR_ANONYMOUS	"小城秘密客"		/* 要短於 IDLEN 個字 */
